...
public class EnumerationUtil {
    ...
    public static <E> Iterator<E> iterator(final Enumeration<? extends E> enumeration) {
        return new EnumerationIterator<E>(enumeration);
    }

    public static <E> Iterable<E> iterable(final Enumeration<? extends E> enumeration) {
