...
public enum BinaryPrefix implements UnitPrefix {
    ...
    KIBI(10, 1, "Ki"), MEBI(20, 2, "Me"), GIBI(30, 3, "Gi"), TEBI(40, 4, "Ti"), PEBI(50, 5, "Pi"), EXBI(60, 6, "Ei"), ZEBI(70, 7, "Zi"), YOBI(80, 8, "Yi");
    ...
    private BinaryPrefix(final int exponent2, final int exponent1024, final String symbol) {
