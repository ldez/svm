...
public enum MetricPrefix implements UnitPrefix {
    ...
    YOTTA(24, "Y"), ZETTA(21, "Z"), EXA(18, "E"), PETA(15, "P"), TERA(12, "T"), GIGA(9, "G"), MEGA(6, "M"), KILO(3, "k"), HECTO(2, "h"), DECA(1, "da"), DECI(-1, "d"), CENTI(-2, "c"), MILLI(-3, "m"), MICRO(-6, "µ"), NANO(-9, "n"), PICO(-12,
            "p"), FEMTO(-15, "f"), ATTO(-18, "a"), ZEPTO(-21, "z"), YOCTO(-24, "y");
    ...
    private static final ObjectTransformer<MetricPrefix, String> KEY_GENERATOR = new ObjectTransformer<MetricPrefix, String>() {
        ...
        @Override
        public String transform(final MetricPrefix from) {
            return from.symbol;
        }
    };
    ...
    public static MetricPrefix getBySymbol(final String symbol) {
    ...
    private MetricPrefix(final int exponent, final String symbol) {
