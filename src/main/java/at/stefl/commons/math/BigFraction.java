...
public final class BigFraction extends Number implements Comparable<Number> {
     ...
     */
    public static BigFraction valueOf(final Number n) {
        if (n == null) {
     ...
     *             if denominator == 0.
     */
    public static BigFraction valueOf(final Number numerator, final Number denominator) {
        if (numerator == null) {
     ...
     *             if denominator == 0.
     */
    public static BigFraction valueOf(final String s) {
     ...
     * Returns this + n.
     */
    public BigFraction add(final Number n) {
        if (n == null) {
        ...
        if (isInt(n)) {
            ...
            return new BigFraction(this.numerator.add(this.denominator.multiply(toBigInteger(n))), this.denominator, Reduced.YES);
        } else {
            final BigFraction f = valueOf(n);

            // n1/d1 + n2/d2 = (n1*d2 + d1*n2)/(d1*d2)
            return new BigFraction(this.numerator.multiply(f.denominator).add(this.denominator.multiply(f.numerator)), this.denominator.multiply(f.denominator), Reduced.NO);
        }
    }
     ...
     * Returns this - n.
     */
    public BigFraction subtract(final Number n) {
        if (n == null) {
            throw new IllegalArgumentException("Null argument");
        }
        ...
        if (isInt(n)) {
            // n1/d1 - n2 = (n1 - d1*n2)/d1
            return new BigFraction(this.numerator.subtract(this.denominator.multiply(toBigInteger(n))), this.denominator, Reduced.YES);
        } else {
            final BigFraction f = valueOf(n);

            // n1/d1 - n2/d2 = (n1*d2 - d1*n2)/(d1*d2)
            return new BigFraction(this.numerator.multiply(f.denominator).subtract(this.denominator.multiply(f.numerator)), this.denominator.multiply(f.denominator), Reduced.NO);
        }
    }
     ...
     * Returns this * n.
     */
    public BigFraction multiply(final Number n) {
        if (n == null) {
            throw new IllegalArgumentException("Null argument");
        }
        ...
        return new BigFraction(this.numerator.multiply(f.numerator), this.denominator.multiply(f.denominator), Reduced.NO);
    }
     ...
     *             if n == 0.
     */
    public BigFraction divide(final Number n) {
        if (n == null) {
            throw new IllegalArgumentException("Null argument");
        }
        ...
        return new BigFraction(this.numerator.multiply(f.denominator), this.denominator.multiply(f.numerator), Reduced.NO);
    }
    ...
    public BigFraction pow(final int exponent) {
        if (exponent < 0 && this.numerator.equals(BigInteger.ZERO)) {
        ...
        if (exponent == 0) {
            ...
            return new BigFraction(this.numerator.pow(exponent), this.denominator.pow(exponent), Reduced.YES);
        } else {
            return new BigFraction(this.denominator.pow(-exponent), this.numerator.pow(-exponent), Reduced.YES);
        }
    }
    ...
    public String toMixedString() {
        ...
        final BigInteger[] divmod = this.numerator.divideAndRemainder(this.denominator);
        return divmod[0] + " " + divmod[1].abs() + "/" + this.denominator;
    }
     ...
     */
    public boolean equalsNumber(final Number n) {
        return this.equals(valueOf(n));
    }
    ...
    public int compareTo(final BigFraction f) {
        ...
        if (this.signum() != f.signum()) {
            return this.signum() - f.signum();
        }

        // next easy case: this and f have the same denominator
        if (this.denominator.equals(f.denominator)) {
            return this.numerator.compareTo(f.numerator);
        }
     ...
     */
    @Override
    public int compareTo(final Number n) {
        return this.compareTo(valueOf(n));
    }
     ...
     */
    public Number min(final Number n) {
        if (n == null) {
            throw new IllegalArgumentException("Null argument");
        }
     ...
     */
    public Number max(final Number n) {
        if (n == null) {
            throw new IllegalArgumentException("Null argument");
        }
    ...
    public BigDecimal toBigDecimal(final int precision) {
        return new BigDecimal(this.numerator).divide(new BigDecimal(this.denominator), new MathContext(precision, RoundingMode.HALF_EVEN));
    }
    ...
    public float floatValue() {
        ...
        return this.toBigDecimal(MathContext.DECIMAL32.getPrecision() + 2).floatValue();
    }
     ...
     *             if denominator == 0.
     */
    private static BigFraction valueOfHelper(final BigDecimal numerator, final BigDecimal denominator) {
     ...
     */
    private static BigInteger toBigInteger(final Number n) {
     ...
     */
    private static boolean isInt(final Number n) {
