...
public enum MtfType {
    ...
    CONVERSION_NONE(MtfTypeConstants.MTF_CONVERSION_NONE), CONVERSION_1BIT_THRESHOLD(MtfTypeConstants.MTF_CONVERSION_1BIT_THRESHOLD), CONVERSION_8BIT_GREYS(MtfTypeConstants.MTF_CONVERSION_8BIT_GREYS);
    ...
    private static final ObjectTransformer<MtfType, Integer> CODE_KEY_GENERATOR = new ObjectTransformer<MtfType, Integer>() {
        ...
        @Override
        public Integer transform(final MtfType value) {
            return value.code;
        }
    };
    ...
    public static MtfType getByCode(final int code) {
        return BY_CODE_MAP.get(code);
    }

    private MtfType(final int code) {
        this.code = code;
    }
