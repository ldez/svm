...
public class LineColorActionTranslator extends ColorActionTranslator<LineColorAction> {
    ...
    @Override
    protected void translateImpl(final LineColorAction action, final SVGStateWriter out, final TranslationState state) throws IOException {
