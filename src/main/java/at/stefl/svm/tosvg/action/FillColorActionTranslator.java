...
public class FillColorActionTranslator extends ColorActionTranslator<FillColorAction> {
    ...
    @Override
    protected void translateImpl(final FillColorAction action, final SVGStateWriter out, final TranslationState state) throws IOException {
