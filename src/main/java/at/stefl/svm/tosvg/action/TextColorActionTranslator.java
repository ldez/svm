...
public class TextColorActionTranslator extends ColorActionTranslator<TextColorAction> {
    ...
    @Override
    protected void translateImpl(final TextColorAction action, final SVGStateWriter out, final TranslationState state) throws IOException {
