...
public class RectangleActionTranslator extends SVGActionTranslator<RectangleAction> {
    ...
    @Override
    protected void translateImpl(final RectangleAction action, final SVGStateWriter out, final TranslationState state) throws IOException {
