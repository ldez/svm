...
public class PolyPolygonActionTranslator extends SVGActionTranslator<PolyPolygonAction> {
    ...
    @Override
    protected void translateImpl(final PolyPolygonAction action, final SVGStateWriter out, final TranslationState state) throws IOException {
        for (final List<Vector2i> polygon : action.getSimplePolyPolygon()) {
